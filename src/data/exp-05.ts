  ...
  theory: [
    {
      ...
      type: 'text',
      visualizationId: 'pca',
      content: 'High-dimensional datasets can be computationally expensive and difficult to analyze. **Principal Component Analysis (PCA)** is an **unsupervised dimensionality reduction** technique that transforms correlated features into uncorrelated **principal components** maximizing **variance**.',
      codeExample: {
        title: 'Applying PCA',
